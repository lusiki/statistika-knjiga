...
def check_parity(root: Path, fixture: str | None) -> int:
    ...
    try:
        ...
        elif fixture == "w16-normal-cache-asymmetry":
            ojs_command.append("w16-cached-normal")
        elif fixture == "w17-normal-cache-asymmetry":
            ojs_command.append("w17-cached-normal")
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        choices=[
            ...
            "w16-normal-cache-asymmetry",
            "w17-normal-cache-asymmetry",
        ],
    )
