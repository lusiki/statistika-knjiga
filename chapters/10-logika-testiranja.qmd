...
Četiri tisuće premještanja pokazuju što nulti model radi s tom statistikom. Uz
raspodjelu stoji razlika koju je dao stvarni raspored oznaka.
...
Dvije usporedne raspodjele rade ono što jedan uzorak ne može. Postupak ponavlja mnogo puta,
...
Zajednička os uspoređuje raspodjelu pod nultim modelom s raspodjelom
procijenjene razlike kada učinak postoji. Tako iste granične crte povezuju
rizike dviju pogrešaka.
...
::: {.callout-model}
Samo traženje testa i p-vrijednosti može preskočiti ono što računu prethodi.
Prije poziva asistentu treba reći koja je
...
Potpuni se postupak može ispisati u nekoliko redaka i vrijedi ga jednom vidjeti
