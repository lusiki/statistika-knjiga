...
s8_se_tablica <- tibble(
  ...
  teorijska = sd(s8_pov) / sqrt(s8_velicine)
)
...
s8 <- list(
  ...
  se_teorijska = sd(s8_pov) / sqrt(100),
  omjer = sd(s8_pov) / sd(s8_sredine100),
...
# Veličina populacije gotovo ne ulazi u preciznost. Isti uzorak od 800 osoba
# izvlačimo iz cijele populacije i iz njezina desetorostruko manjeg dijela.
