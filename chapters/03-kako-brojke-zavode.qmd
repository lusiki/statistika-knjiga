...
Karticu za čitanje ankete, uvedenu u poglavlju o mjerenju i dizajnu, ovdje
primjenjujemo na objavljeni rezultat. U nju
...
::: {.callout-model}
Provjera počinje točnim naslovom službene objave, stranicom i pet objavljenih
...
otvaramo citirani dokument i pronalazimo svaki broj. Opći
[protokol za rad s asistentom](../dodaci/f-ai-protokol.qmd#sec-protokol-asistenta)
čuva taj trag izvora i provjere i nakon završetka Dijela I.
...
Na kraju Dijela I skeptičnost postaje vidljiv postupak, a ne navika odbacivanja.
Prijelaz od podatka do suda usporava ovih šest pitanja.
...
Iz odgovora nastaje puna karta tvrdnji. Vrsta tvrdnje i njezin doseg dvije su
