...
<!-- =====================================================================
  ...
  5. Krivulja snage izmjerena je permutacijskim postupkom iz prethodnog
     poglavlja, pa se vrijednost pri tristo jedinica poklapa s ondje izmjerenom
     stopom. To je namjerno, jer je riječ o istoj brojci pod dva imena.
...
# Jedna studija zadane veličine. Vraća procjenu razlike i permutacijsku
# p-vrijednost, dakle točno ono što bi istraživač izvijestio.
s11_studija <- function(velicina, permutacija = 200) {
  ...
  c(razlika, mean(abs(nulte) >= abs(razlika)))
}
