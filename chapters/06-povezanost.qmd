...
::: {.callout-model}
Rad počinje opisom raspršenoga dijagrama, a tek zatim dolazi račun Pearsonove i
Spearmanove korelacije. Od asistenta tražimo provjeru oblika, krajnjih i
...
oblik odnosa, a ne navodi uzrok, jer je riječ o simuliranom presječnom skupu bez
istraživačke intervencije i bez zabilježenoga vremenskog redoslijeda.

## Od odnosa do tvrdnje

Dio II završava razlikom između opisa podataka i dopuštenja za tvrdnju o njima.
Put od retka u datoteci do rečenice koju čitatelj smije prenijeti drugome zato
pratimo na Eurostatovu presjeku kroz šest revizijskih pitanja.
...
Odgovore čitamo kao lanac. Promijeni li se jedinica, mijenjaju se
...
Taj lanac određuje **granicu tvrdnje o povezanosti**. Jedinica, obuhvat i način
