...
#| echo: false
#| label: fig-w14
#| fig-cap: "Planirani prikaz dviju skupina i distribucije njihove razlike."
#| fig-alt: "Mjesto za dvije skupine opažanja i histogram razlika sredina."
ggplot() +
...
tibble(
  razlika = diff(rev(test_dvije$estimate)),
  donja = test_dvije$conf.int[1],
  gornja = test_dvije$conf.int[2]
) |>
