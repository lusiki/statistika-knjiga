...
učenje, koje je u očekivanju optimističnije od uspješnosti na novim jedinicama
i prividno se poboljšava sa svakom dodanom varijablom. Tablica u ovom poglavlju
mjeri koliko je razlika velika, jer je model s dodanim slučajnim brojevima na
svojem uzorku griješio manje, a na odvojenom skupu više nego postupak koji
svakome pripiše prosjek. Odgovor bi tražio skup podataka odvojen prije procjene,
i tek tada izračunatu pogrešku uz istu vremensku granicu prediktora.
:::
:::
...
::: {.content-visible when-profile="kolegij"}
Rješenje mora razlikovati samoprijavljenu uporabu od binariziranih simptoma,
imenovati skupinu do tri sata kao referentnu i pročitati 1,60 kao prilagođeni
omjer izgleda s intervalom od 1,43 do 1,80. Apsolutna vjerojatnost nije
dostupna bez polazišne vjerojatnosti ili cijelog modela. Dopuštena rečenica
navodi da su u presječnim samoprijavljenim podacima norveški adolescenti od 15
do 16 godina s više od tri sata uporabe imali 1,60 puta onolike prilagođene
izglede da budu na ili iznad 80. percentila simptoma kao referentna skupina do
tri sata, uz navedene prilagodbe (AOR 1,60; 95 % interval 1,43–1,80). Ne tvrdi
učinak, rizik ni promjenu od 60 postotnih bodova.
:::
