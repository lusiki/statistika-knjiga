...
Interaktivni i tiskani prikaz razdvajaju dvije stvari koje su u prethodna tri
odjeljka ispisane kao gotov rezultat. U digitalnom izdanju čitatelj pomiče pravac i
...
::: {.callout-model}
Prilagodba modela, dijagnostički prikazi i prijevod koeficijenata u prozu mogu
se delegirati. Prije poziva asistentu treba zadati ulogu svake varijable,
...
sudjelovali u procjeni. [Protokol za rad s
asistentom](../dodaci/f-ai-protokol.qmd#sec-protokol-asistenta) ovdje traži da
cilj modela, dostupnost varijabli i neovisna provjera ostanu vidljivi.
