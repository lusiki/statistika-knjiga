...
Jedina je pogreška nepotpun ključ spajanja. Godina se u godišnjoj tablici
ponavlja po platformi, pa svaki mjesečni redak dobiva više parova. Aritmetika
nad umnoženim retcima jest točna, ali tablica više nema jedan redak po
`mjesec + platforma`: 3.571 redak nosi samo 438 različitih ključeva. Ispravan
ključ `godina + platforma` zadržava 438 redaka i zbroj 710.307. Prazna oznaka
nakon spajanja ne bi otkrila ovu pogrešku jer svaki je pogrešni redak dobio par.
:::
:::
