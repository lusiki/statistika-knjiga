...
<!-- =====================================================================
  ...
  3. Pedagoški slijed dijela o mjerama raspršenosti naslijeđen je od Navarra
     (navarro2019). Proza je izvorna, ali licenčna napomena u references.bib
     ostaje na snazi.
...
situacijama primjerenija od obične sredine [@navarro2019].
...
kolegija [@navarro2019]. Puni se argument ne može izvesti prije nego što
...
Upotrijebite `anketa_mreze`. Izračunajte sredinu, medijan, standardnu
devijaciju i interkvartilni raspon varijable `minute_dnevno` za cijeli uzorak i
za svaku dobnu skupinu, a zatim ponovite izračun nad logaritmiranim
vrijednostima. Predajte jednu tablicu i dvije rečenice o tome koji se sažetak
promjenom ljestvice najviše promijenio.
