...
::: {.callout-model}
Kod bootstrapa ispravan kod još ne jamči ispravan plan ponovnog uzorkovanja.
Provjeravamo predstavlja li početni uzorak
...
Tu provjeru vodi sljedeći stupanj
[protokola za rad s asistentom](../dodaci/f-ai-protokol.qmd#sec-protokol-asistenta).
Račun se prihvaća tek nakon provjere ciljne populacije, jedinice i zaključka.
...
Procjena prelazi u tvrdnju tek kad se povežu vjerojatnost, uzorkovanje i doseg.
Šest revizijskih pitanja sprječava da uzak raspon postane dopuštenje za širu
tvrdnju od one koju podaci i postupak mogu nositi. Razrađeni primjer daje ove
odgovore.
...
Odgovori omeđuju rečenicu koja se smije prenijeti. Oni ne pretvaraju
sintetičku populaciju u empirijski dokaz, a izostavljenu mjernu nesigurnost ili
nesigurnost kodiranja ne skrivaju unutar uzoračkoga raspona. Šest mogućih dosega
iste analize zatim razdvaja karta tvrdnji.
