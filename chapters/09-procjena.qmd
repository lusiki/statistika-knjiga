...
#| fig-cap: "Interval pouzdanosti za sredinu i raspon unutar kojega leži otprilike 95 % pojedinačnih ocjena, na istom uzorku i istoj osi."
#| fig-alt: "Dvije vodoravne crte iste sredine. Gornja, koja se odnosi na prosjek, kratka je i jedva vidljiva. Donja, koja se odnosi na pojedinačne ocjene, proteže se preko gotovo cijele širine grafa."

s9_usporedba <- tibble(
  tip = factor(
    c("Interval za sredinu", "Raspon pojedinačnih ocjena"),
    levels = c("Interval za sredinu", "Raspon pojedinačnih ocjena")
  ),
  donja = c(s9$donja, s9$sredina - s9$predikcijski),
  gornja = c(s9$gornja, s9$sredina + s9$predikcijski)
)
